...
<div class="container">
  ...
  <h3>Sharing</h3>
  <div class="paket">
    <div class="card" data-name="1u1p Netflix" data-price="27.000">
      <h4>1u1p</h4>
      <p>Rp.27.000</p>
    </div>
    <div class="card" data-name="1u2p Netflix" data-price="17.000">
      <h4>1u2p</h4>
      <p>Rp.17.000</p>
    </div>
  </div>
  ...
  <h3>Private</h3>
  <div class="paket">
    <div class="card" data-name="Private Netflix 720p" data-price="125.000">
      <h4>Private (720p)</h4>
      <p>Rp.125.000</p>
    </div>
  </div>
...
<script src="{{ asset('/js/netflix.js') }}"></script>
